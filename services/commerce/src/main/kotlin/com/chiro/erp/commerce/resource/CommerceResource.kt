...
class CommerceResource {
    ...
    fun getProductsByCategory(@PathParam("category") category: String): Uni<List<Product>> {
    ...
    fun updateProductStock(@PathParam("id") id: Long, request: UpdateStockRequest): Uni<Response> {
